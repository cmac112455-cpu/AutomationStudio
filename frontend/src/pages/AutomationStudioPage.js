    ...
    const templates = {
      'video-ad-creator': {
        ...
        nodes: [
          ...
          {id: 'ai-1', type: 'gemini', position: {x: 300, y: 50}, data: {prompt: 'Create a detailed 4-second video scene description for the FIRST PART of a product advertisement with a voiceover script that will be split across 2 videos. Requirements:\n\n1. PRODUCT & SCENE: Be extremely specific - describe exact product (e.g. "silver laptop", "blue water bottle"), exact setting (e.g. "white marble desk", "wooden kitchen table"), exact lighting (e.g. "morning sunlight from left"), and exact camera movement (e.g. "camera slowly pans right").\n\n2. VOICEOVER SCRIPT: Create a compelling 2-part script that will be split:\n   - Part 1 (this video): Should END MID-SENTENCE or MID-PHRASE to create suspense\n   - Example: "What fuels your-" or "Discover the secret to-" or "Transform your morning with-"\n   \n3. FORMAT:\n   Scene: [Detailed visual description]\n   Voiceover Part 1: "[Your text that ends mid-sentence]"\n   \nUse only concrete, professional language. The script MUST end incomplete to continue in video 2.', model: 'gemini-2.5-pro'}},
          ...
          {id: 'ai-2', type: 'gemini', position: {x: 700, y: 200}, data: {prompt: 'Continue the advertisement from the previous AI response. Create the SECOND PART that seamlessly continues both the visual scene AND completes the voiceover script. Requirements:\n\n1. VISUAL CONTINUATION: Describe the next 4 seconds - exact actions (e.g. "screen lights up", "lid opens"), exact visual changes (e.g. "blue interface appears", "steam rises"), exact camera movement (e.g. "camera zooms in 30%").\n\n2. COMPLETE THE VOICEOVER: Finish the sentence/phrase that was left incomplete in Part 1.\n   - If Part 1 was: "What fuels your-"\n   - Part 2 should be: "day for maximum health and energy"\n   - Result: "What fuels your day for maximum health and energy"\n\n3. FORMAT:\n   Scene: [Detailed visual description continuing from previous]\n   Voiceover Part 2: "[Complete the sentence from Part 1]"\n   \nUse concrete, professional language. The voiceover MUST complete the script naturally.', model: 'gemini-2.5-pro'}},
